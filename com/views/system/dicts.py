...
from com.forms.system.dicts import DictForm, DictSearchForm
...
def index():   
    ...
    return render_template('system/dict/index.html', pagination=pagination, dictionaries=dictionaries, form=form)
...
def edit(id):
    ...
    if form.validate_on_submit():
        ...
        flash('字典信息更新成功！')
        return redirect(url_for('.index'))
    return render_template('system/dict/edit.html', form=form)
